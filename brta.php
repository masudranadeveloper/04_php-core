...
<div class="imgtem w100 position-relative" id="pdf">
    ...
    <span class="g  g7v"><?php echo $user['certi_no']; ?></span>
    ...
    if ($type == 'One') { ?>
        ...
        <span class="g  g8v"> <?php echo $user['national_id']; ?> </span>
    ...
    <span class="g  g9v"><?php echo $user['passport_no']; ?></span>


    <span class="g l g10">Nationality:</span>
    <span class="g l g10-2">জাতীয়তা:</span>
    <span class="g  g10v"><?php echo $user['nationality']; ?></span>
    ...
    <?php if ($host_last1 == "") { ?>
    <span class="g  g11v"><?php echo $user['name']; ?></span>
    <?php } else { ?> 
    ...
    <span class="g  g12v"><?php echo date("d-m-Y", strtotime($user['date_birth'])); ?></span>


    <span class="g l g13">Gender:</span>
    <span class="g l g13-2">লিঙ্গ:</span>
    <span class="g  g13v"><?php echo $user['gender']; ?></span>


    <span class="g r g14">Date of Vaccination (Dose 1):</span>
    <span class="g r g14-2">টিকা প্রদানের তারিখ (ডোজ ১):</span>
    <span class="g  g14v"><?php echo  date("d-m-Y", strtotime($user['doseone_date'])); ?></span>
    ...
    <span class="g24-3"><?php echo date("d-m-Y", strtotime($user['dosethree_date'])); ?></span>
    ...
    <span class="signeture">
        <img src="<?php echo $user['qr_code']; ?>" alt="">
    </span>
...
<!-- 
    <div class="imgtem w100 position-relative" id="pdf" style="height: 1412px;">
        ...
        <span class="b b1"><?php echo $user['certi_no']; ?></span>
        <span class="b b2"><?php echo $user['name']; ?></span>
        ...
        if ($type == 'One') { ?>
            ...
            <span class="b b3"> <?php echo $user['national_id']; ?> </span>
        ...
        <span class="b b3"><?php echo $user['passport_no']; ?></span>
