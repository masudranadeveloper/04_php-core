                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php $amount = $obj->get_balance($row['id']); echo $amount;?></td>
                        <td><?php echo $row['UserEmail']; ?></td>
                        <td><?php echo $row['RegDate']; ?></td>
                        <td><a style="min-width: 106px;" class="btn btn-success rounded-pill" href="add_balance.php?id=<?php echo $row['id']; ?>"><i class="bi bi-plus-circle"></i> Balance</a></td>
